...
void mmc_init(void)
{
    ...
    apic_irq_init(31, APIC_PRI_3, 0, mmc0_interrupt);
    apic_enable(31);
    apic_irq_init(32, APIC_PRI_3, 0, mmc1_interrupt);
    apic_enable(32);
